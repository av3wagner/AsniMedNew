...
#cwd = 'C:\IPYNBgesamt\ASNI-FEN\ASNI-Report\PRODUKTION'
cwd = 'C:\IPYNBgesamt2025\AsFenForum2025'
DirPr = cwd
DirData=os.path.join(cwd, "data")
DirAssets=os.path.join(cwd, "ASSETS")
#DirImage=os.path.join(cwd, "ASSETS\Image")
#DirImageNow=os.path.join(cwd, "ASSETS\ImageNow")
