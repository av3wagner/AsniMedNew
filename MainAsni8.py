...
print("#;;;****************************************************************;;;")
print("#;;;*--------------------------------------------------------------*;;;")
print("#;;;*---  PROGRAMM      : Asni2025-V07C.ipynb                   ---*;;;")
print("#;;;*---  Parent        : Asni2025-V07B.ipynb                   ---*;;;")
...
def RunEda():
    ...
    exec(open(r"C:\IPYNBgesamt2025\AsFenForum2025\EDA-Report2025.py").read(), globals())
    import time
    time.sleep(5.0)  
...
def RunML():
    ...
    import time
    time.sleep(5.0)     
    return f"assets/AsniML2025.html"    
...
#path="C:\\IPYNBgesamt2025\\AProjekte\\AktuellProjekte\\AsFenForum2025\\ASSETS\\"
#os.chdir(r"C:/IPYNBgesamt2025/AProjekte/AktuellProjekte/AsFenForum2025") 
#os.chdir(r"C:/AW75/AsfendiyarovAI")
    ...
    [
     ...
     dbc.Nav(
            [
                ...
                dbc.NavLink('Старт "АИС ВТИ"', href="/page-11", active="exact"),
    ...
    if pathname == "/":    
       return html.Div([  
        ...
        return html.Div([  
           html.Div(
              #http://localhost:8502 
              html.Iframe(id="demo-explanation", src="https://newrepo-bznelcmfgujvrm6vabulaw.streamlit.app/?embed=true", width=1670, height=1010),
                           style={'width':'99.5%',"height": '1200px','display':'inline-block',
                           'overflow-y':'auto', 'color': 'yellow', "font-size": "1.4rem",
                           'backgroundColor': 'black', 
                           'marginLeft':50, 'marginRight':250, 'vertical-align':'middle'},
                           className="four columns instruction",      
          ...
          return html.Div([  
           html.Div(
               #http://localhost:8089
               html.Iframe(id="demo-explanation", src="https://nnkz.onrender.com/", width=1670, height=1010), 
                           style={'width':'99.5%',"height": '1200px','display':'inline-block',
                           'overflow-y':'auto', 'color': 'yellow', "font-size": "1.4rem",
                           'backgroundColor': 'black', 
                           'marginLeft':50, 'marginRight':250, 'vertical-align':'middle'},
...
@app.callback(
    ...
    Input("input2", "value") #, prevent_initial_call=True
)
...
def update_output_div(input_value):
    print(input_value)
    #path="C:\\IPYNBgesamt2025\\AProjekte\\AktuellProjekte\\AsFenForum2025\\"
    if input_value == "C:\IPYNBgesamt2025\AsFenForum2025\ML-Reports2025.py":
        execfile(r"C:\\IPYNBgesamt2025\\AProjekte\\AktuellProjekte\\AsFenForum2025\\ML-Reports2025.py")
        import time
        time.sleep(5.0)    
        return f"assets/AsniML2025.html" 
    
    elif input_value == "C:\IPYNBgesamt2025\AsFenForum2025\EDA-Report2025.py":
        execfile(r"C:\\IPYNBgesamt2025\\AProjekte\\AktuellProjekte\\AsFenForum2025\\\EDA-Report2025.py")
        import time
        time.sleep(5.0)    
        return f"assets/RunEDA-Report.html"  
